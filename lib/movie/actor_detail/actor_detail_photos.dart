...
import 'package:hakuna/widget/movie_photo_list.dart';
    ...
    if (photos.length == 0) {
      ...
      children.add(
        Container(
          ...
          child: Text('暂无相册',style: TextStyle(color: AppColor.white, fontSize: fixedFontSize(14))
          ),
        )
      );
    }
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Text('相册',style: TextStyle(fontSize: fixedFontSize(16),fontWeight: FontWeight.bold,color: AppColor.white)),
          ),
          SizedBox(height: 10,),
          SizedBox.fromSize(
